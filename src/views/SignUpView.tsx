...
export const SignUpView: React.FC<SignUpViewProps> = ({
  ...
  const handleOAuthStart = (provider: 'google' | 'github' | 'microsoft') => {
    ...
    <div className="signup-page-wrapper">
      ...
      <div className="signup-right-panel">
        <div className="signup-anim-form" style={{ width: '100%', maxWidth: '380px' }}>
          ...
          {/* Social Auth Buttons Row (Google, GitHub & Microsoft - Icon Only) */}
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '24px' }}>
            ...
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="#111827">
                <path d="M1 1h10v10H1z M13 1h10v10H13z M1 13h10v10H1z M13 13h10v10H13z" />
              </svg>
            </button>
          </div>
